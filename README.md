...
If you are not running with **NODE_ENV = "production"** you must have a *config.js* file with your project with a *discord bot token*, a *random message* and the bot admin *info*.
